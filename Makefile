...
#CFLAGS=-Xc -xO4 -g -I$(CFITSIO_INC) -I$(PGPLOT_INC) -I$(SLA_INC) -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -DCSLALIB -DHAVE_MMAP -D__EXTENSIONS__
...
LIGHTCURVES_SRCS=main.c buffer.c chooseap.c lightcurves.c pcasys.c plots.c systematic.c \
	hjd.c sla.c \
